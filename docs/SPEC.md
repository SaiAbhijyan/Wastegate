...
| `wg ask\|run\|chat --repo DIR [--mock --replies DIR \| --live \| --dry-run] [--max-steps N] [--oneshot]` | agent | tool loop (read/grep/edit/shell/pytest) + verification gate; see docs/AGENT.md |
